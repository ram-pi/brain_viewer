...
var dir_labels_lh = __parentDir + "/pages/brainbrowser/models/surfaces/labels/lh_a2009s";
var dir_labels_rh = __parentDir + "/pages/brainbrowser/models/surfaces/labels/rh_a2009s";
var annot_ctab = __parentDir + "/pages/brainbrowser/models/surfaces/labels/aparc.annot.ctab";
var annot_ctab_a2009s = __parentDir + "/pages/brainbrowser/models/surfaces/labels/aparc.annot.a2009s.ctab";

exports.findSurfaceLabel = function(index) {
	console.log("surfaceLabelFinde.js:You are searching for " + index);
	...
	for (var f in files) 
	{
		...
		{
			var label = files[f];
			console.log("surfaceLabelFinde.js:You have found the index in the label file " + files[f]);
...
exports.findColorInAnnotation = function(label) {
	console.log("surfaceLabelFinde.js:Find color annotation for label " + label);
